...
struct CloudSyncCollectionSemanticIdentity: Hashable, Sendable {
  ...
  var ruleset: CardCollectionRuleset
  ...
  init(listID: CardCollectionRecord.ID, snapshot: CardCollectionLibrarySnapshot) {
