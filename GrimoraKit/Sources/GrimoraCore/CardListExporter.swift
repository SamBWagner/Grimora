...
public enum CardListExportFormat: String, CaseIterable, Identifiable, Sendable {
    case text
    case csv
    case arena
    case mtgoDek
...
public enum CardListExportTextSectionHeader: String, CaseIterable, Identifiable, Sendable {
    case none
    case generic
    case cardType
...
public enum CardListExportCSVColumn: String, CaseIterable, Identifiable, Sendable {
    case quantity
    case category
    case name
    case setName
...
public enum CardListDeckRegistrationSortMode: String, CaseIterable, Identifiable, Sendable {
    case alphabetical
    case manaValue
    case color
    case type
...
public struct CardListDeckRegistrationFields: Equatable, Sendable {
...
public struct CardListExportConfiguration: Equatable, Sendable {
    public var format: CardListExportFormat
    ...
    public var textSectionHeader: CardListExportTextSectionHeader
    public var csvColumns: [CardListExportCSVColumn]
    public var csvIncludesHeaderRow: Bool
    public var deckRegistrationFields: CardListDeckRegistrationFields
    public var deckRegistrationSortMode: CardListDeckRegistrationSortMode

    public init(
        format: CardListExportFormat = .text,
        ...
        textSectionHeader: CardListExportTextSectionHeader = .none,
        csvColumns: [CardListExportCSVColumn] = CardListExportCSVColumn.allCases,
        csvIncludesHeaderRow: Bool = true,
        deckRegistrationFields: CardListDeckRegistrationFields = CardListDeckRegistrationFields(),
        deckRegistrationSortMode: CardListDeckRegistrationSortMode = .alphabetical
    ) {
        self.format = format
    ...
    public static func defaultConfiguration(format: CardListExportFormat = .text) -> Self {
        Self(format: format)
    }
}

public struct CardListExportResult: Equatable, Sendable {
    public var format: CardListExportFormat
...
public enum CardListExporter {
    public static func export(
        list: CardListRecord,
        entries: [CardListEntryRecord],
        categories: [CardListCategoryRecord] = [],
        configuration: CardListExportConfiguration,
        date: Date = Date()
    ) -> CardListExportResult {
        ...
        case .grimoraArchive:
            let document = CardListArchiveCoder.document(
                list: list,
                entries: entries,
            ...
            do {
                return CardListExportResult(
                    format: configuration.format,
                    data: try CardListArchiveCoder.encode(document),
                    preview: preview,
                    filename: filename,
    ...
    private static func aggregate(_ entries: [CardListEntryRecord]) -> (
    ...
    private static func csvValue(
        for column: CardListExportCSVColumn,
        card: AggregatedCard
    ) -> String {
        switch column {
        case .quantity:
    ...
    private static func sortedDeckRegistrationCards(
        ...
        sortMode: CardListDeckRegistrationSortMode
    ) -> [AggregatedCard] {
    ...
    private static func fileName(for list: CardListRecord, format: CardListExportFormat) -> String {
    ...
    private static func hasDescription(_ list: CardListRecord) -> Bool {
