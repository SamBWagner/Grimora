...
public enum CardListRuleset: String, CaseIterable, Codable, Identifiable, Sendable {
    case none
    case commander
    case standard
    case pioneer
    ...
    public var allowedZones: [CardListZone] {
        switch self {
        case .commander:
    ...
    public func normalizedZone(_ zone: CardListZone) -> CardListZone {
...
public enum CardListZone: String, CaseIterable, Codable, Identifiable, Sendable {
    case commander
    case mainboard
    case sideboard
    case maybeboard
...
public enum CardListViewMode: String, CaseIterable, Codable, Identifiable, Sendable {
    case grid
    case list
...
public struct CardListRecord: Identifiable, Codable, Equatable, Sendable {
...
public struct CardListEntryRecord: Identifiable, Codable, Equatable, Sendable {
    public var id: String
...
public struct CardListCategoryRecord: Identifiable, Codable, Equatable, Sendable {
    public var id: String
    public var listID: String
    public var zone: CardListZone
    public var name: String
...
public struct CardListLibrarySnapshot: Codable, Equatable, Sendable {
    public var lists: [CardListRecord]
    public var categories: [CardListCategoryRecord]
    public var entries: [CardListEntryRecord]

    public init(
        lists: [CardListRecord],
...
public enum CardListDatabaseError: Error, Equatable, Sendable {
    case emptyName
    case listNotFound
