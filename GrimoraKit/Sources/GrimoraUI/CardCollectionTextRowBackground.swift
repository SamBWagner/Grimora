...
struct CardCollectionTextRowBackground: View {
    var card: CardRecord?
    ...
    private var colorIdentityStyle: CardCollectionTextRowColorIdentityStyle {
        CardCollectionTextRowColorIdentityStyle(card: card)
    }
