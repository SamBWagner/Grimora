...
final class CardCollectionExporterTests: XCTestCase {
    func testTextExportAggregatesDuplicatePrintsAndHonorsPrintOptions() {
        ...
        var configuration = CardCollectionExportConfiguration(format: .text)
        configuration.textUsesFrontNameOnlyForMDFC = true

        let result = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
        ...
        let compactResult = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
            configuration: configuration
        )
    ...
    func testTextExportSupportsGenericAndCardTypeSectionHeaders() {
        ...
        let genericResult = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
            configuration: configuration
        )
        ...
        let cardTypeResult = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
            configuration: configuration
        )
    ...
    func testCSVExportEscapesSelectedColumnsAndMissingValues() {
        ...
        var configuration = CardCollectionExportConfiguration(format: .csv)
    ...
    func testArenaAndMTGOExportsReportUnavailablePrintsAndFallbacks() {
        ...
        let arenaResult = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
            configuration: CardCollectionExportConfiguration(format: .arena)
        )
        ...
        let mtgoResult = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
            configuration: CardCollectionExportConfiguration(format: .mtgoDek)
        )
    ...
    func testDeckRegistrationPDFProducesDataAndSortedPreview() throws {
        ...
        var configuration = CardCollectionExportConfiguration(format: .deckRegistrationPDF)
        configuration.deckRegistrationFields = CardCollectionDeckRegistrationFields(
    ...
    func testCategoryExportsGroupSupportedFormatsAndWarnForFlatFormats() {
        ...
        let text = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
            categories: categories,
            configuration: CardCollectionExportConfiguration(format: .text)
        )
        XCTAssertEqual(
            text.content,
            """
        ...
        var csvConfiguration = CardCollectionExportConfiguration(format: .csv)
        csvConfiguration.csvColumns = [.quantity, .category, .name]
        let csv = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
            categories: categories,
        ...
        let edhrec = CardCollectionExporter.export(
            list: testList(name: "Naya Box"),
            entries: entries,
            categories: categories,
            configuration: CardCollectionExportConfiguration(format: .edhrecArticle)
        )
        XCTAssertEqual(
            edhrec.content,
            """
        ...
        let deckRegistration = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
            categories: categories,
            configuration: CardCollectionExportConfiguration(format: .deckRegistrationPDF)
        )
        ...
        let arena = CardCollectionExporter.export(
            list: testList(),
            entries: entries,
            categories: categories,
            configuration: CardCollectionExportConfiguration(format: .arena)
